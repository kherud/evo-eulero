...
public class GeneticSolver {
    ...
    public void evolve() {
        ...
        System.out.println("Generation " + generation + " -- " + population[0].getFitness() + " -- " + testSort());
        generation++;
    }
    ...
    public boolean testSort(){
        ...
        for (int i = 0; i < 2048; i++){
            correct = lastFitness <= population[i].getFitness();
            lastFitness = population[i].getFitness();
        }
        return correct;
    }
